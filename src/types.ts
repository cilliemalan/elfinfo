...
export interface ELF {
    ...
    /** Get the first section in which this symbol is addressed. */
    getSectionForSymbol(symbol: ELFSymbol): ELFSectionHeaderEntry;
    /** Get all sections in which this symbol is addressed. */
    getSectionsForSymbol(symbol: ELFSymbol): ELFSectionHeaderEntry[];
    /** Get the first segment in which this symbol is addressed. */
    getSegmentForSymbol(symbol: ELFSymbol): ELFProgramHeaderEntry;
    /** Get all segments in which this symbol is addressed. */
    ...
    /** Get the first section that matches the given name (case-insensitive). */
    getSectionByName(sectionName: string): ELFSectionHeaderEntry;
    /** Get all sections that matches the given name (case-insensitive). */
    getSectionsByName(sectionName: string): ELFSectionHeaderEntry[];
    /** Get the first symbol that matches the given name (case-insensitive). */
    getSymbolByName(symbolName: string): ELFSymbol;
    /** Get all symbols that matches the given name (case-insensitive). */
